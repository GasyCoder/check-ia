        ...
        <div class="min-h-screen flex transition-colors duration-300 bg-slate-50 dark:bg-[#212121]">
            ...
            >
                ...
                <div class="px-3 pt-3 pb-1 shrink-0">
                    ...
                    <a href="/app" class="flex items-center gap-2.5 w-full px-3 py-2.5 rounded-lg text-sm font-medium transition-all border border-dashed text-slate-600 dark:text-[#ccc] border-slate-300 dark:border-[#444] hover:border-slate-400 dark:hover:border-[#666] hover:bg-slate-200/50 dark:hover:bg-[#2a2a2a]" @click="sidebarOpen = false">
                ...
                <div class="flex-1 overflow-y-auto px-3 py-2">
                    <div class="space-y-px">
                        <a
                            ...
                            :key="det.id"
                            :href="`/app?from_history=${det.id}`"
                            class="flex items-center gap-2.5 px-3 py-2 rounded-lg text-[13px] transition-colors text-slate-600 dark:text-[#b4b4b4] hover:bg-slate-200/70 dark:hover:bg-[#2a2a2a]"
                    ...
                    >
                        <div v-if="userMenuOpen" class="mx-3 mb-1 rounded-xl border bg-white dark:bg-[#2a2a2a] border-slate-200 dark:border-[#3a3a3a] shadow-lg overflow-hidden">
                            ...
                            <div class="py-1">
                                ...
                                <a href="/history" class="flex items-center gap-3 px-4 py-2 text-sm transition-colors text-slate-700 dark:text-[#ccc] hover:bg-slate-50 dark:hover:bg-[#333]" @click="sidebarOpen = false; userMenuOpen = false">
                                ...
                                <button @click="toggleTheme; userMenuOpen = false" class="w-full flex items-center gap-3 px-4 py-2 text-sm transition-colors text-slate-700 dark:text-[#ccc] hover:bg-slate-50 dark:hover:bg-[#333]">
                            ...
                            <div class="border-t border-slate-100 dark:border-[#3a3a3a] py-1">
                                <button @click="logout" class="w-full flex items-center gap-3 px-4 py-2 text-sm transition-colors text-slate-700 dark:text-[#ccc] hover:bg-slate-50 dark:hover:bg-[#333]">
